...
import { useGenresMovieQuery, useSortMovieQuery, useTopRatedMoviesQuery } from "../../features/movie/movieApiSlice";
...
const TopRatedMovie = () => {
    ...
    const { data: topRatedData, isError: isErrU, error: errU, isLoading: isLoadU } = useTopRatedMoviesQuery(page);
    ...
    const handleToprated = () => {
        if (topRatedData?.results) {
            setAllMovies(topRatedData.results)
        }
    }

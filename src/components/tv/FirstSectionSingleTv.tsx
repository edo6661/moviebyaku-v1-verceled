...
import HoverIcon from "../singleMovie/HoverIcon";
        ...
        <>
            ...
            <div className='innerSingleMovie'>
                ...
                <div className='detailsSingleMovie  '>
                    <h2 className=' '>{name} <span className='text-myWhite'>({first_air_date.substring(0, 4)})</span></h2>
                    <div className='secondDetailsSingleMovie'>
                        <p>({first_air_date}) (US)</p>
                    ...
                    {!isErrE && !loadingE && external ?
                        <div className="flex gap-2 mt-2 ">
                            ...
                            {external?.imdb_id ? <HoverIcon IconComponent={FaImdb} color="#deb522" to={`https://www.imdb.com/name/${external?.imdb_id}`} /> : ''}
                        </div> : ''
                    }
                    {errMsgFav}
                    {errMsgWl}
...
export default FirstSectionSingleTv